                ...
                <Jumbotron>
                    <Container>
                        <Col>
                            ...
                            {this.state.showResult ? <p>Transaction ID: <a href={"https://testnet.algoexplorer.io/tx/"+this.state.txId} target="_blank" rel="noopener noreferrer">View detailed transaction information</a></p> : null}
                        </Col>
                    </Container>
                </Jumbotron>
            </div>
